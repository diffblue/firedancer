...
#define FD_F25519_ALIGN __attribute__((aligned(64)))
...
#define FD_R52X5_QUAD_PACK( Q, x, y, z, t ) do {                  \
    long _x[8] FD_F25519_ALIGN; wwl_st( _x, (x) );   \
    long _y[8] FD_F25519_ALIGN; wwl_st( _y, (y) );   \
    long _z[8] FD_F25519_ALIGN; wwl_st( _z, (z) );   \
    long _t[8] FD_F25519_ALIGN; wwl_st( _t, (t) );   \
...
/* D = 16*p - S.
   A lazy negation, the 16*p bias keeps all limbs
   positive for inputs under the usual <2^54 bound. */
...
/* Weak carry propogation modulo p.
   Carries flow through limbs 0..4, and limb 4's carry wraps into
   limb 0 multiplied by 19, as 2^255 = 19 mod p. */
#define FD_R52X5_QUAD_REDUCE( D, S ) do {                  \
    ...
    wl_t _s4 = S##4;                                       \
                                                           \
    wl_t _mask = wl_bcast( FD_F25519_LIMB_MASK );          \
...
fd_r52x5_quad_mul_fast( wl_t * _z0, wl_t * _z1, wl_t * _z2, wl_t * _z3, wl_t * _z4,
  ...
  z1_1 = wl_madd52lo( z1_1, r19, z6 ); z1_2 = wl_madd52hi( z1_2, r19, z5 );
  z2_1 = wl_madd52lo( z2_1, r19, z7 ); z2_2 = wl_madd52hi( z2_2, r19, z6 );
  z3_1 = wl_madd52lo( z3_1, r19, z8 ); z3_2 = wl_madd52hi( z3_2, r19, z7 );
  z4_1 = wl_madd52lo( z4_1, r19, z9 ); z4_2 = wl_madd52hi( z4_2, r19, z8 );
